...
<head>
  <meta charset="UTF-8">
  <title>DUSA Analytics</title>
  
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
  
<script src="https://use.fontawesome.com/79b67d8b1a.js"></script>
...
.login h1, .login h5 { color: #fff; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:center; }
...
<body>
    <div class="login">
	<h1><i class="fa fa-bar-chart"></i> DUSA Analytics</h1>
